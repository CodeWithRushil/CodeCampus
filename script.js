...
document.addEventListener("DOMContentLoaded", async () => {
  ...
  quickStatsData.forEach((status) => {
    const statCard = document.createElement("div");
    statCard.className = "stat-card";
    statCard.setAttribute("data-aos", "fade-up");
    statCard.setAttribute("data-aos-delay", status.delay);
  ...
  projects.forEach((project) => {
    ...
    <span class="task-status status-${project.status
      .toLowerCase()
  ...
  const recommendations = [
    ...
    {
      course: "Introduction to Algorithm by CLRS",
      difficulty: "Advanced",
    },
    {
      course: "Linear Differential Equation",
      difficulty: "Intermediate",
    },
    {
      course: "Schrodinger Equation",
      difficulty: "Advanced",
    },
    {
  ...
  document.querySelectorAll(".sidebar-nav-item").forEach((item) => {
    item.addEventListener("click", function () {
      ...
      if (ignoreList.includes(this.dataset.section)) return;

      document
        .getElementById(previousActiveSection)
        ?.classList.remove("active");
      previousActiveSection = this.dataset.section;
      document.getElementById(previousActiveSection).classList.add("active");
    });
  });
